...
export default function AdminDashboard() {
  const navLinks = [
    { path: '/admin/dashboard', label: 'HOME', active: true },
    ...
    <PageLayout navLinks={navLinks}>
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#0A2A43] mb-4">Admin Dashboard</h1>
          <p className="text-[#6D7A86] text-lg">Oversee and manage all system cases</p>
        </div>
