...
export default function Home() {
  return (
    <div className="min-h-screen bg-linear-gradient-to-br from-gray-50 to-gray-100">
      <Navbar showAuth={true} />

      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-linear-gradient-to-r from-[#0A2A43] via-[#1a3a53] to-[#0A2A43] rounded-3xl p-8 md:p-16 mb-16 text-center shadow-2xl relative overflow-hidden">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <ServiceCard
              icon={Activity}
              title="TRACK STATUS"
              description="Stay informed with real-time progress updates on your filed FIRs and missing person reports."
              registerPath="/track-status"
            />
          </div>
        </section>
